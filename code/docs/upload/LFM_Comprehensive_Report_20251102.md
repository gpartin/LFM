...
We track relative energy drift \|ΔE\| / \|E₀\| and target ≤ 10⁻⁶ ...
10⁻⁴ depending on grid and BCs.
...
## 5 Pass/Fail Framework
  ...
  ----------------------- ----------------------- -----------------------
  1                       Lorentz isotropy &      Δv/c ≤ 1 %, anisotropy
                          dispersion              ≤ 1 %, energy drift ≤
                                                  1×10⁻⁶
...
GRAV-11,Time delay — packet through χ slab (Shapiro-like) (NEEDS DEBUG: Packet tracking measurement issues),SKIP,Packet tracking diagnostics WIP; Shapiro-like delay measurement
...
GRAV-14,Group delay — differential timing with vs without slab (NEEDS DEBUG: Signal too weak to measure delay),SKIP,Signal too weak for robust differential timing with current setup
...
### GRAV-11: Time delay — packet through χ slab (Shapiro-like) (NEEDS DEBUG: Packet tracking measurement issues) (Skipped: Packet tracking diagnostics WIP; Shapiro-like delay measurement)
**Status:** SKIP
...
### GRAV-14: Group delay — differential timing with vs without slab (NEEDS DEBUG: Signal too weak to measure delay) (Skipped: Signal too weak for robust differential timing with current setup)
**Status:** SKIP
