...
gravitational analogues arise through the curvature field χ(x,t).
...
∇\_Δ² E_i = (E\_{i+1} − 2E_i + E\_{i−1}) / (Δx)²

1D Laplacian (order-4):

∇\_Δ² E_i = \[−E\_{i+2} + 16E\_{i+1} − 30E_i + 16E\_{i−1} − E\_{i−2}\] /
(12 (Δx)²)
...
Terms such as E\_{t+1} = E_t + α∇²E − nH E belong to higher-tier
...
E\_{I,t+1} = E\_{I,t} + α(φ\_{i+1,t} − φ\_{i−1,t}) − βB\_{I,t}

B\_{I,t+1} = B\_{I,t} + β(φ\_{i+1,t} − φ\_{i−1,t}) + αE\_{I,t}
...
Promoting χ to a dynamic field yields coupled Euler–Lagrange
equations:  
...
|----|----|----|----|
| Klein–Gordon | E_tt − c²∇²E + m²E = 0 | LFM with constant χ | — |
| Variable-mass KG | E_tt − c²∇²E + χ(x,t)²E = 0 | Identical continuum form | Ebert & Nascimento (2017) |
| Helmholtz | ∇²u + k_eff²(x)u = 0 | Time-harmonic analogue | Yagdjian (2012) |
| Quantum-walk lattices | Discrete Dirac/KG | Emergent Lorentz symmetry | Bisio et al. (2015) |
