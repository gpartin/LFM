...
| Discrete time step defines a natural quantization scale (ℏ_eff = ΔE_min Δt). | Natural quantization scale |
...
|----|----|----|----|
| Laboratory | Cavity or interferometer | Discrete dispersion / anisotropy | Planned |
| Astrophysical | GRB timing / ringdown | χ-dependent delay or shift | Analysis |
| Numerical | Tier 1–3 GPU lattice runs | Lorentz & energy conservation | PASS |
