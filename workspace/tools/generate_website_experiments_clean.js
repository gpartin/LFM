...
function main() {
  ...
  console.log(`✅ Generated ${experiments.length} research experiments`);
  ...
  console.log(`✅ Generated test statistics: ${stats.passRate}`);
...
if (require.main === module) {
  try { process.exit(main()); } catch (e) { console.error('❌ Error generating experiments:', e); process.exit(1); }
}
