...
from utils.lfm_diagnostics import field_spectrum, energy_total, energy_flow, phase_corr
...
class Tier1Harness(BaseTierHarness):
    ...
    def measure_boost_covariance(self, E_series: List[np.ndarray], dt: float, dx: float, 
        ...
        """
        from physics.lorentz_transform import verify_klein_gordon_covariance
