...
- LFM Innovation: Spatially-varying χ-field implementation
- Enables unified physics simulation on discrete spacetime lattice
...
try:
    ...
    from lfm_plotting import plot_field_evolution
    LFM_AVAILABLE = True
except ImportError:
    LFM_AVAILABLE = False
