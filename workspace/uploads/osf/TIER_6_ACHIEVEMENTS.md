...
- **Total Tier 6 — Multi-Domain Coupling Tests**: 3
- **Tests Passed**: 1 (33.3%)

## Test Results Summary

| Test ID | Status | Description |
|---------|--------|-------------|| COUP-01 | FAIL | Relativistic + Gravitational Time Dilation (Phase 1) || COUP-02 | PASS | Wave Propagation Speed (1D Analytical Validation with L2 Convergence) || COUP-07 | FAIL | EM Wave in χ-Gradient (Phase 1) |
## Significance
